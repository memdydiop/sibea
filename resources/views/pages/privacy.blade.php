...
<div>
    <section class="on-dark relative bg-nuit text-white py-16 overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 class="font-display font-extrabold text-4xl lg:text-5xl">Politique de confidentialité</h1>
        </div>
    </section>

    <section class="max-w-4xl mx-auto px-6 lg:px-8 py-16">
    <div class="prose max-w-none text-anthracite">
        <h2 class="font-display font-bold text-nuit text-2xl mt-8 mb-4">Données collectées</h2>
        ...
        <h2 class="font-display font-bold text-nuit text-2xl mt-8 mb-4">Vos droits</h2>
        ...
        <h2 class="font-display font-bold text-nuit text-2xl mt-8 mb-4">Cookies</h2>
