            ...
            <div class="lg:col-span-2">
                ...
                <dl class="space-y-6">
                    <div class="flex gap-4 items-start">
                        <span class="flex-shrink-0 w-12 h-12 rounded-xl bg-cuivre/10 flex items-center justify-center" aria-hidden="true">
                            <svg class="w-6 h-6 text-cuivre" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </span>
                        <div>
                    ...
                    <div class="flex gap-4 items-start">
                        <span class="flex-shrink-0 w-12 h-12 rounded-xl bg-cuivre/10 flex items-center justify-center" aria-hidden="true">
                            <svg class="w-6 h-6 text-cuivre" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        </span>
                        <div>
                    ...
                    <div class="flex gap-4 items-start">
                        <span class="flex-shrink-0 w-12 h-12 rounded-xl bg-cuivre/10 flex items-center justify-center" aria-hidden="true">
                            <svg class="w-6 h-6 text-cuivre" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </span>
                        <div>
                    ...
                    <div class="border border-bordure rounded-lg bg-surface p-8 lg:p-10">
                        ...
                        <form wire:submit="submit" class="space-y-5">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="budget" type="text" placeholder="Ex. 25 000 000 FCFA" />
                                <flux:error name="budget" />
                            </flux:field>

                            <flux:field>
                                <flux:label>Message *</flux:label>
                                <flux:textarea wire:model="message" rows="5" placeholder="Décrivez votre projet, vos besoins, vos contraintes…" />
                                <flux:error name="message" />
                            </flux:field>

                            <flux:field>
                                <flux:checkbox wire:model="consent" />
                                <flux:label>J’accepte la <a href="{{ route('privacy') }}" class="underline text-cuivre" target="_blank">politique de confidentialité</a> *</flux:label>
