...
<div>
    <section class="relative bg-nuit text-white py-16 overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 class="font-[Manrope] font-extrabold text-4xl lg:text-5xl">Mentions légales</h1>
        </div>
    </section>

    <section class="max-w-4xl mx-auto px-6 lg:px-8 py-16">
    <div class="prose max-w-none text-anthracite">
        <h2 class="font-[Manrope] font-bold text-2xl mt-8 mb-4">Éditeur du site</h2>
        <p>Groupe SIBEA — site vitrine institutionnel.</p>
        <h2 class="font-[Manrope] font-bold text-2xl mt-8 mb-4">Propriété intellectuelle</h2>
        <p>L’ensemble des contenus de ce site est protégé. Toute reproduction sans autorisation est interdite.</p>
        <h2 class="font-[Manrope] font-bold text-2xl mt-8 mb-4">Données personnelles</h2>
