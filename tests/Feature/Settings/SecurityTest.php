...
test('security settings page can be rendered', function () {
    ...
    $response->assertSee('Aucune clé d’accès pour le moment');
    $response->assertSee('Authentification à deux facteurs');
    $response->assertSee('Activer la 2FA');
});
...
test('security settings page renders without two factor when feature is disabled', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertDontSee('Gérez vos clés d’accès pour une connexion sans mot de passe')
